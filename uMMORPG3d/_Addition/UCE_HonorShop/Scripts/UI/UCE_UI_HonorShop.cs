...
public partial class UCE_UI_CSHONORSHOP : MonoBehaviour
{
    public GameObject panel;
    public Button categorySlotPrefab;
    public Transform categoryContent;
    public ScrollRect scrollRect;
    public UCE_UI_CSHONORSHOPSlot itemSlotPrefab;
    ...
    private void Update()
    {
            ...
            panel.activeSelf)
        {
            ...
            if (npc.itemShopCategories.Length > 0)
            {
                ...
                {
                    UCE_UI_CSHONORSHOPSlot slot = itemContent.GetChild(i).GetComponent<UCE_UI_CSHONORSHOPSlot>();
