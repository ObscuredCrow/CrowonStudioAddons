...
public partial class Player
{
    ...
    public void calcJump(float horizontal, float vertical)
    {
        ...
        {
            parabola = UCE_MathParabola.Parabola(startJumpPositiontmp, endJumpPositiontmp, jumpHeight, i);
    ...
    private void ChangeJumpPosition()
    {
        ...
        transform.position = UCE_MathParabola.Parabola(startJumpPosition, endJumpPosition, 3f, Mathf.Clamp01(jumpDelta / 0.75f));
